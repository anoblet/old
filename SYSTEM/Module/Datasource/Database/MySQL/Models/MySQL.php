<?PHP
    NameSpace SYSTEM\Module\Datasource\Database\MySQL\Models
    {

        Class MySQL Extends \SYSTEM\Module\Datasource\Database\MySQL Implements \SYSTEM\Module\Datasource\__Interface
        {
